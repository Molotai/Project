...
using FuelMonitor.QuartzServices;
...
namespace FuelMonitor
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<FuelContext>(options =>
            ...
            //services.AddScoped<ISignalRService, SignalR>();
            ...
            services.AddScoped <Services.Monitor>();
